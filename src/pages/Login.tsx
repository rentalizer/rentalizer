...
import { LogIn, UserPlus, User, Lock, ArrowLeft } from 'lucide-react';
    ...
    try {
      if (isSignUp) {
        ...
        toast({
          ...
          description: "Welcome! You can now access the calculator.",
        });
      } else {
        ...
        <Card className="bg-slate-700/90 backdrop-blur-lg border border-gray-500/50">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-400">
              {isSignUp 
                ? "Create your account to access the calculator"
