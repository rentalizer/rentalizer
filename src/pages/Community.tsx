...
const Community = () => {
  ...
  useEffect(() => {
    localStorage.setItem('community-theme', isDayMode ? 'day' : 'night');
  }, [isDayMode]);
      ...
      <div className={`min-h-screen flex flex-col transition-all duration-500 ${
        ...
        <div className="flex-1 w-full max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                className={`ml-4 ${isDayMode ? 'text-slate-600 hover:text-slate-800' : 'text-gray-400 hover:text-cyan-300'}`}
              >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* Discussions Tab with Community Header */}
            <TabsContent value="discussions" className="mt-8 space-y-6">
              <CommunityHeader onPostCreated={handlePostCreated} isDayMode={isDayMode} />
              <GroupDiscussions refreshTrigger={refreshTrigger} isDayMode={isDayMode} />
            </TabsContent>
