    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
      ...
      <section className="py-6 px-4">
        <div className="max-w-3xl mx-auto">
          <Card className="mx-auto w-full sm:max-w-xl bg-slate-900/80 backdrop-blur-md border-2 border-primary/70 hover:border-primary/80 transition-all shadow-2xl shadow-primary/25 hover:shadow-primary/35 relative overflow-hidden text-center">
