      ...
      <div className="container max-w-4xl mx-auto px-6 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm mt-1">Student Portal Activity Log</p>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Select value={selectedStudent.id} onValueChange={(value) => {
                    ...
                    <SelectTrigger className="w-full max-w-md bg-white border-gray-300 text-gray-900">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-white border-gray-200">
                      {students.map((student) => (
                        <SelectItem key={student.id} value={student.id} className="text-gray-900 focus:bg-gray-100">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-900">{selectedStudent.joinedDate}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="text-gray-600">Progress:</span>
                    <span className="text-gray-900">{selectedStudent.progress}%</span>
                  </div>
                  {selectedStudent.id === '7' && (
                    <div className="flex items-center gap-1">
                      <span className="text-gray-600">Revenue:</span>
                      <span className="text-green-600">$5,000.00</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="space-y-2">
            {filteredActivities.map((activity, index) => {
              ...
              return (
                <Card 
                  key={activity.id} 
                  className="bg-white border-gray-200 hover:border-gray-300 transition-all duration-200 hover:bg-gray-50 shadow-sm"
                >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-4 mb-2">
                              ...
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                                ...
                                <span className="text-gray-700">{activity.documentDownloaded}</span>
                              </div>
                            </div>
                            ...
                            <div className="mb-3">
                              <div className="flex items-center gap-2 mb-1">
                                <span className="text-xs text-gray-600">Download Progress:</span>
                                <span className="text-xs text-green-600 font-medium">{activity.downloadProgress}%</span>
                              </div>
                              <Progress 
                            ...
                            <div className="flex items-center gap-3">
                              <Badge 
                                variant="outline" 
                                className={`text-xs ${
                                  typeColor === 'blue' ? 'border-blue-500 text-blue-700 bg-blue-50' :
                                  typeColor === 'purple' ? 'border-purple-500 text-purple-700 bg-purple-50' :
                              ...
                              <span className="text-xs text-gray-700 font-mono">Server ID#: </span>
                              <span className="text-xs text-gray-900 font-mono font-medium">{activity.serverId}</span>
                            </div>
                          </div>
...
export default ClientPortalLog1;
