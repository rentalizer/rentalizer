...
const Index = () => {
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 py-16">
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-16">
              <Card 
                className="bg-slate-800/50 border-cyan-500/20 backdrop-blur-lg hover:border-cyan-400/40 transition-all duration-300 group cursor-pointer"
              ...
              <Card 
                className="bg-slate-800/50 border-blue-500/20 backdrop-blur-lg hover:border-blue-400/40 transition-all duration-300 group cursor-pointer"
              ...
              <Card 
                className="bg-slate-800/50 border-purple-500/20 backdrop-blur-lg hover:border-purple-400/40 transition-all duration-300 group cursor-pointer"
  ...
  // Authenticated and subscribed users see the same clean layout
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      <TopNavBar />
