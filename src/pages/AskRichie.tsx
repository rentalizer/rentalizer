        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4">
              Get Instant Answers from Richie's AI
            </h1>
            <p className="text-xl text-gray-300 mb-6 max-w-3xl mx-auto">
              Trained on all of Richie's live coaching sessions, documents, and rental arbitrage expertise. 
              Get the guidance you need to build your rental business 24/7.
            </p>
            
            <div className="flex justify-center mb-8">
              <LoginDialog
                trigger={
                  <Button size="lg" className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white px-8 py-3">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pricingPlans.map((plan) => (
                <Card 
                  key={plan.id} 
                  className={`relative bg-slate-800/50 border-gray-700/50 backdrop-blur-lg ${
                    plan.popular ? 'border-cyan-500/50 ring-2 ring-cyan-500/20' : ''
                  }`}
                >
                  {plan.popular && (
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            {pricingPlans.map((plan) => (
              <Card 
                key={plan.id} 
                className={`cursor-pointer transition-all bg-slate-800/50 border-gray-700/50 backdrop-blur-lg hover:border-cyan-500/50 ${
                  plan.popular ? 'border-cyan-500/50 ring-2 ring-cyan-500/20' : ''
                }`}
