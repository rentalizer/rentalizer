          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="space-y-3">
                ...
                {/* Enhanced file attachments display - now outside textarea and more prominent */}
                {attachedFiles.length > 0 && (
                  <div className="bg-slate-700/30 border border-cyan-500/20 rounded-lg p-3 space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {attachedFiles.map((file, index) => (
                        <div key={index} className="flex items-center justify-between bg-slate-600/50 rounded-lg px-3 py-2 border border-slate-500/30">
              ...
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center gap-2 relative">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`${attachedFiles.length > 0 ? 'text-cyan-400 bg-cyan-500/10' : 'text-gray-400'} hover:text-cyan-300`}
