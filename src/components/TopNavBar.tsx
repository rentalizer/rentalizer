...
export const TopNavBar = () => {
  ...
  return (
    <div className="w-full bg-slate-800 border-b border-slate-700 px-6 py-4">
      <div className="flex items-center justify-between">
        {/* Left side - Logo and Rentalizer text */}
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl font-bold text-white">Rentalizer</span>
        </div>
