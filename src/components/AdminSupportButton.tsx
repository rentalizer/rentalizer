...
export default function AdminSupportButton() {
          ...
          <div className="flex items-center justify-between p-4 border-b-2 border-border bg-muted/20 rounded-t-xl">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold">
                {isAdmin ? 'Admin Support Center' : 'Support'}
              </h2>
              {unreadCount > 0 && (
  ...
  return (
    ...
    >
      ...
      {unreadCount > 0 && (
        <div className="absolute -top-2 -right-2 bg-destructive text-destructive-foreground rounded-full min-w-5 h-5 text-xs flex items-center justify-center px-1 animate-pulse">
