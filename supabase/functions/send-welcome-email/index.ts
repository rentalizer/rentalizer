...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      ...
      html: `
        <h1>Welcome to Ask Richie AI!</h1>
        <p>Thank you for signing up for Ask Richie AI - your intelligent assistant for rental arbitrage and real estate insights.</p>
        ...
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #0891b2;">
          ...
          <p style="margin: 0;">You now have trial access to our AI-powered rental arbitrage insights and market intelligence tools.</p>
        </div>
        
        <h3>What you can do with your trial access:</h3>
        <ul>
          <li>🤖 Ask Richie AI questions about rental arbitrage</li>
        ...
        <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><a href="https://inspiring-genie-a1691.lovable.app/askrichie" style="color: #0891b2; text-decoration: none;">🚀 Start chatting with Richie AI now</a></p>
          <p><a href="https://inspiring-genie-a1691.lovable.app/market-analysis" style="color: #0891b2; text-decoration: none;">📊 Analyze properties</a></p>
        ...
        <p>Best regards,<br>The Ask Richie AI Team</p>
        
        <hr style="margin: 30px 0; border: none; border-top: 1px solid #eee;">
        <p style="font-size: 12px; color: #666;">
          This email was sent because you created an account at Ask Richie AI. 
