...
const promoCodeRequestRoutes = require('./routes/promoCodeRequest');
...
// Serve uploaded files statically (ensure absolute path for all environments)
...
app.use('/api/student-log', studentLogRoutes);
